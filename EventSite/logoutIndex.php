...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarResponsive">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item" ><span style="padding-left:240px">
        <a class="btn btn-primary btn-lg active" href="logout.php">&nbsp Logout</a>
      </li>
        ...
        <table id="eventtable" class="table table-striped">  
          ...
          <tbody>  
            <tr>  
              ...
              <td><a href="favourite/index.php">☆Favourite</a></td> 
