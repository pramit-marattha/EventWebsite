...
<div class="wrapper" id="main">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <span style="font-size:20px; cursor:pointer; color: green;" onclick="openNav()">&#9776; Open Menu  </span>
...
?>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
           ...
           <a href="show_img.php"><h1>Gallery</h1></a>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-orange">
            <div class="inner">
             ...
             <a href="displayevent.php"><h1>Events</h1></a>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
           ...
           $query="SELECT count(*) as total from user_info";
           $result=mysqli_query($conn,$query);
           $countall=mysqli_fetch_assoc($result);
           echo $countall['total'];?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3 class="card-title" style="text-align:center;"><?php
           $query="SELECT count(*) as total from user_info where status=1 and role=2";
           $result=mysqli_query($conn,$query);
           $countall=mysqli_fetch_assoc($result);
           echo $countall['total'];?></h3>
 ...
 <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3 class="card-title" style="text-align:center;"><?php
           $query="SELECT count(*) as total from user_info where role=1 and status=1";
           $result=mysqli_query($conn,$query);
           $countall=mysqli_fetch_assoc($result);
           echo $countall['total'];?></h3>
